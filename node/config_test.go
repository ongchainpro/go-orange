...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gong.ipc", false, filepath.Join(os.TempDir(), "gong.ipc")},
		{"data", "gong.ipc", false, "data/gong.ipc"},
		{"data", "./gong.ipc", false, "./gong.ipc"},
		{"data", "/gong.ipc", false, "/gong.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gong.ipc", true, `\\.\pipe\gong.ipc`},
		{"data", "gong.ipc", true, `\\.\pipe\gong.ipc`},
		{"data", `\\.\pipe\gong.ipc`, true, `\\.\pipe\gong.ipc`},
	}
