...
// Tests whonger a Lifecycle can be registered.
...
// Tests whonger a service's protocols can be registered properly on the node's p2p server.
...
// Tests whonger a handler can be successfully mounted on the canonical HTTP server
// on the given prefix
...
// Tests whonger websocket requests can be handled on the same port as a regular http server.
