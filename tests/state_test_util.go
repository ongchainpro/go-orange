...
// See https://github.com/ong2020/EIPs/issues/176 for the test format specification.
...
func MakePreState(db ongdb.Database, accounts core.GenesisAlloc, snapshotter bool) (*snapshot.Tree, *state.StateDB) {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/ong2020/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
