...
func (f *fuzzer) fuzz() int {
	...
	for i, pair := range []struct {
		...
		{ongash.FrontierDifficultyCalulator, ongash.CalcDifficultyFrontierU256},
		{ongash.HomesteadDifficultyCalulator, ongash.CalcDifficultyHomesteadU256},
		{ongash.DynamicDifficultyCalculator(bombDelay), ongash.MakeDifficultyCalculatorU256(bombDelay)},
	} {
