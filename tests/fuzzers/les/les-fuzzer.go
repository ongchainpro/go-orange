...
import (
	...
	l "github.com/ong2020/go-orange/les"
...
var (
	...
	bankFunds  = new(big.Int).Mul(big.NewInt(100), big.NewInt(params.Oranger))
...
func makechain() (bc *core.BlockChain, addrHashes, txHashes []common.Hash) {
	...
	blocks, _ := core.GenerateChain(gspec.Config, genesis, ongash.NewFaker(), db, testChainLen,
	...
	bc, _ = core.NewBlockChain(db, nil, gspec.Config, ongash.NewFaker(), vm.Config{}, nil, nil)
