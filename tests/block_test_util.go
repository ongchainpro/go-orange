...
// Package tests implements execution of Orange JSON tests.
package tests
...
/* See https://github.com/ong2020/tests/wiki/Blockchain-Tests-II

   Whonger a block is valid or not is a bit subtle, it's defined by presence of
