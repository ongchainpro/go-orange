...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Orange presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gong wallet import /path/to/my/presale.wallet

will prompt for your password and imports your onger presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Orange presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gong wallet [options] /path/to/my/presale.wallet
...
between orange nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gong account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gong account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another orange instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gongConfig{Node: defaultNodeConfig()}
	// Load config file.
