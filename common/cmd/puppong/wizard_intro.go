...
// makeWizard creates and returns a new puppong wizard.
...
// setting up a new or managing an existing Orange private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppong, your Orange private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Orange network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and ongstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppong uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering Orange network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppong", w.network)
