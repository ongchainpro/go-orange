...
// NewSuite creates and returns a new ong-test suite that can
...
func (s *Suite) TestMaliciousStatus(t *utesting.T) {
	...
	conn.handshake(t)
	status := &Status{
		ProtocolVersion: uint32(conn.ongProtocolVersion),
...
// TestGetBlockHeaders tests whonger the given node can respond to
...
// TestGetBlockBodies tests whonger the given node can respond to
...
// TestBroadcast tests whonger a block announcement is correctly
