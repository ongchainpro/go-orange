...
func (c *Conn) write66(req ong.Packet, code int) error {
...
func (c *Conn) read66() (uint64, Message) {
	...
	case (GetBlockHeaders{}).Code():
		ongMsg := new(ong.GetBlockHeadersPacket66)
...
func (s *Suite) getBlockHeaders66(t *utesting.T, conn *Conn, req ong.Packet, expectedID uint64) BlockHeaders {
