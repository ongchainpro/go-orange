...
// TestGetBlockHeaders_66 tests whonger the given node can respond to
...
func (s *Suite) TestGetBlockHeaders_66(t *utesting.T) {
	...
	// get block headers
	req := &ong.GetBlockHeadersPacket66{
		RequestId: 3,
		GetBlockHeadersPacket: &ong.GetBlockHeadersPacket{
...
func (s *Suite) TestSimultaneousRequests_66(t *utesting.T) {
	...
	// create two requests
	req1 := &ong.GetBlockHeadersPacket66{
		RequestId: 111,
		GetBlockHeadersPacket: &ong.GetBlockHeadersPacket{
			Origin: ong.HashOrNumber{
				Hash: s.chain.blocks[1].Hash(),
	...
	req2 := &ong.GetBlockHeadersPacket66{
		RequestId: 222,
		GetBlockHeadersPacket: &ong.GetBlockHeadersPacket{
			Origin: ong.HashOrNumber{
				Hash: s.chain.blocks[1].Hash(),
...
// TestBroadcast_66 tests whonger a block announcement is correctly
...
// TestGetBlockBodies_66 tests whonger the given node can respond to
...
func (s *Suite) TestGetBlockBodies_66(t *utesting.T) {
	...
	id := uint64(55)
	req := &ong.GetBlockBodiesPacket66{
		RequestId: id,
		GetBlockBodiesPacket: ong.GetBlockBodiesPacket{
