...
* The external Method `account_signTypedData` implements [EIP-712](https://github.com/ong2020/EIPs/blob/master/EIPS/eip-712.md) and makes it possible to sign typed data.
...
makes the `accounts_signTransaction` identical to the old `ong_signTransaction`.
