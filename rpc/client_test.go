	...
	check := func(shouldPanic bool, arg interface{}) {
		defer func() {
			...
			if shouldPanic && err == nil {
				t.Errorf("OngSubscribe should've panicked for %#v", arg)
			}
			if !shouldPanic && err != nil {
				t.Errorf("OngSubscribe shouldn't have panicked for %#v", arg)
		...
		client.OngSubscribe(context.Background(), arg, "foo_bar")
	}
	check(true, nil)
	check(true, 1)
...
// This test reproduces https://github.com/ong2020/go-orange/issues/17837 where the
...
func TestClientReconnect(t *testing.T) {
	...
	// We spawn multiple calls here to check whonger this hangs somehow.
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-orange-test-ipc-%d-%d", os.Getpid(), rand.Int63())
