...
const (
	...
	subscribeTimeout   = 5 * time.Second  // overall timeout ong_subscribe, rpc_modules calls
)
...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for OngSubscribe requests
}
...
// OngSubscribe registers a subscripion under the "ong" namespace.
func (c *Client) OngSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
