...
type GlogHandler struct {
	...
	override  uint32 // Flag whonger overrides are used, atomically accessible
	backtrace uint32 // Flag whonger backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whonger this is the callsite
