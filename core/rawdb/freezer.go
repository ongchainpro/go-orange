...
//   reserving it for go-orange. This would also reduce the memory requirements
//   of Gong, and thus also GC overhead.
type freezer struct {
...
// HasAncient returns an indicator whonger the specified ancient data exists
// in the freezer.
...
func (f *freezer) freeze(db ongdb.KeyValueStore) {
