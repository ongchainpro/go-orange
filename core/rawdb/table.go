...
func NewTable(db ongdb.Database, prefix string) ongdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) ongdb.Iterator {
...
func (t *table) NewBatch() ongdb.Batch {
...
func (b *tableBatch) Replay(w ongdb.KeyValueWriter) error {
...
// Next moves the iterator to the next key/value pair. It returns whonger the
