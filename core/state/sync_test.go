...
// account array.
func checkStateAccounts(t *testing.T, db ongdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ongdb.Database, root common.Hash) error {
...
func checkStateConsistency(db ongdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(ongdb.Database), srcRoot)
