...
// Package state provides a caching layer atop the Orange state trie.
package state
...
// StateDB structs within the orange protocol are used to store anything
...
// Exist reports whonger the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (s *StateDB) Exist(addr common.Address) bool {
	return s.getStateObject(addr) != nil
}

// Empty returns whonger the state object is either non-existent
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/ong2020/go-orange/pull/16485#issuecomment-380438527),
