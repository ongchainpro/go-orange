...
// newDiffLayer creates a new diff on top of an existing snapshot, whonger that's a low
...
// Stale return whonger this layer has become stale (was flattened across) or if
// it's still live.
...
func (dl *diffLayer) AccountRLP(hash common.Hash) ([]byte, error) {
	// Check the bloom filter first whonger there's even a point in reaching into
...
func (dl *diffLayer) flatten() snapshot {
	...
	// be smarter about grouping flattens togonger).
