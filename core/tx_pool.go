...
const (
	...
	// to validate whonger they fit into the pool or not.
...
type TxPoolConfig struct {
	...
	NoLocals  bool             // Whonger local transaction handling should be disabled
...
type TxPool struct {
	...
	istanbul bool // Fork indicator whonger we are in the istanbul stage.
	eip2718  bool // Fork indicator whonger we are using EIP-2718 type transactions.
...
// validateTx checks whonger a transaction is valid according to the consensus
...
// and returns whonger it was inserted or an older was better.
//
// Note, this Method assumes the pool lock is held!
...
// Has returns an indicator whonger txpool has a transaction cached with the
// given hash.
...
// should return the indicator whonger the iteration needs to be continued.
