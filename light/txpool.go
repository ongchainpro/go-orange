...
type TxPool struct {
	...
	eip2718  bool // Fork indicator whonger we are in the eip2718 stage.
}

// TxRelayBackend provides an interface to the mechanism that forwards transacions
// to the ONG network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whonger a transaction is valid according to the consensus rules.
