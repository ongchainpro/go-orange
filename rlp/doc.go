...
binary data, and RLP is the main encoding Method used to serialize objects in Orange.
The only purpose of RLP is to encode structure; encoding specific atomic data types (eg.
strings, ints, floats) is left up to higher-order protocols. In Orange integers must be
