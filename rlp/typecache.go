...
type tags struct {
	// rlp:"nil" controls whonger empty input results in a nil pointer.
	nilOK bool

	// This controls whonger nil pointers are encoded/decoded as empty strings
	// or empty lists.
	nilKind Kind

	// rlp:"tail" controls whonger this field swallows additional list
...
// defaultNilKind determines whonger a nil pointer to typ encodes/decodes
