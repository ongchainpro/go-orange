...
// the `coin_type` 60' (or 0x8000003C) to Orange.
//
// The root path for Orange is m/44'/60'/0'/0 according to the specification
// from https://github.com/ong2020/EIPs/issues/84, albeit it's not set in stone
// yet whonger accounts should increment the last component or the children of
