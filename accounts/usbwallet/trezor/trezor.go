...
// 2.1.0 (Model T). The Orange address representation was changed from the 20
...
//go:generate protoc -I/usr/local/include:. --go_out=import_path=trezor:. messages.proto messages-common.proto messages-management.proto messages-orange.proto
//go:generate protoc --proto_path=/xxxxxx/go-orange/accounts/usbwallet/trezor --go_out=/xxxxx/go-orange/accounts/usbwallet/trezor/ messages.proto messages-common.proto messages-management.proto messages-orange.proto
