...
func (mc *mockCaller) CallContract(ctx context.Context, call orange.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call orange.CallMsg) ([]byte, error) {
