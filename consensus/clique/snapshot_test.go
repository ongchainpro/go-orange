...
// mapped from textual names used in the tests below to actual Orange private
...
// address retrieves the Orange address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Orange address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/ong2020/go-orange/issues/17593). Whilst this
