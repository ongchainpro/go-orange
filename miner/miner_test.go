...
// TestMinerSetOrangerbase checks that ongerbase becomes set even if mining isn't
// possible at the moment
func TestMinerSetOrangerbase(t *testing.T) {
	miner, mux := createMiner(t)
...
func createMiner(t *testing.T) (*Miner, *event.TypeMux) {
	// Create Ongash config
	config := Config{
		Orangerbase: common.HexToAddress("123456789"),
	}
	// Create chainConfig
	memdb := memorydb.New()
