...
// Package enr implements Orange Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whonger the record is signed using the given identity scheme.
