...
creating a collection of devp2p nodes, connecting them togonger to form a
...
* `Expect` - an expectation function which returns whonger or not a
...
As a concrete example, consider a simulated network of Orange nodes. An
