...
import (
	...
	"github.com/ong2020/go-orange/crypto/ecies"
...
// len(data) depending on whonger snappy compression is enabled.
...
type authMsgV4 struct {
	gotPlain bool // whonger read packet had plain format.
