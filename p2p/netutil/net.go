...
// Contains reports whonger the given IP is contained in the list.
...
// IsLAN reports whonger an IP is a local network address.
...
// IsSpecialNetwork reports whonger an IP is located in a special-use network range
...
// CheckRelayIP reports whonger an IP relayed from the given sender IP
...
// SameNet reports whonger two IP addresses have an equal prefix of the given bit length.
...
// Contains whonger the given IP is contained in the set.
