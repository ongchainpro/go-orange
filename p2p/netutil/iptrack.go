...
// PredictFullConeNAT checks whonger the local host is behind full cone NAT. It predicts by
// checking whonger any statement has been received from a node we didn't contact before
