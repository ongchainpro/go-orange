...
// isInitDone returns whonger the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whonger the caller wants liveness-checked results. If
