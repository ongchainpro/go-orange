...
type Database struct {
	diskdb ongdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb ongdb.KeyValueStore) *Database {
...
func (db *Database) DiskDB() ongdb.KeyValueStore {
	return db.diskdb
}
...
// are referenced togonger by database itself.
...
func (db *Database) commit(hash common.Hash, batch ongdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
