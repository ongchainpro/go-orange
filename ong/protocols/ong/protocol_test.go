...
// TestOng66EmptyMessages tests encoding of empty ong66 messages
func TestOng66EmptyMessages(t *testing.T) {
...
// TestOng66Messages tests the encoding of all redefined ong66 messages
func TestOng66Messages(t *testing.T) {
