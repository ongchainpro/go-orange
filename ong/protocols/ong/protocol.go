...
// is primary).
var ProtocolVersions = []uint{ONG34, ONG33, ONG32}

// protocolLengths are the number of implemented message corresponding to
// different protocol versions.
var protocolLengths = map[uint]uint64{ONG34: 17, ONG33: 17, ONG32: 17}

// maxMessageSize is the maximum cap on the size of a protocol message.
const maxMessageSize = 10 * 1024 * 1024

const (
	// Protocol messages in ong/64
	StatusMsg          = 0x00
	...
	// Protocol messages overloaded in ong/65
...
// StatusPacket is the network packet for the status message for ong/64 and later.
...
// GetBlockHeadersPacket represents a block header query over ong/66
...
// BlockHeadersPacket represents a block header response over ong/66.
...
// GetBlockBodiesPacket represents a block body query over ong/66.
...
// BlockBodiesPacket is the network packet for block content distribution over ong/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over ong/66
...
// GetNodeDataPacket represents a trie node data query over ong/66.
...
// NodeDataPacket is the network packet for trie node data distribution over ong/66.
...
// GetReceiptsPacket represents a block receipts query over ong/66.
...
// ReceiptsPacket is the network packet for block receipts distribution over ong/66.
...
// ReceiptsPacket66 is the ong-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket is the network packet for transaction distribution over ong/66.
...
// PooledTransactionsRLPPacket66 is the ong/66 form of PooledTransactionsRLPPacket
