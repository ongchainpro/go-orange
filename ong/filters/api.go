...
// information related to the Orange protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(orange.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as orange.FilterQuery but with UnmarshalJSON() Method.
type FilterCriteria orange.FilterQuery
...
//
// https://ong.wiki/json-rpc/API#ong_uninstallfilter
...
//
// https://ong.wiki/json-rpc/API#ong_getfilterlogs
...
//
// https://ong.wiki/json-rpc/API#ong_getfilterchanges
