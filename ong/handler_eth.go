...
// ongHandler implements the ong.Backend interface to handle the various network
...
func (h *ongHandler) RunPeer(peer *ong.Peer, hand ong.Handler) error {
	return (*handler)(h).runOngPeer(peer, hand)
}
...
// AcceptTxs retrieves whonger transaction processing is enabled on the node
...
func (h *ongHandler) handleHeaders(peer *ong.Peer, headers []*types.Header) error {
...
func (h *ongHandler) handleBodies(peer *ong.Peer, txs [][]*types.Transaction, uncles [][]*types.Header) error {
...
func (h *ongHandler) handleBlockAnnounces(peer *ong.Peer, hashes []common.Hash, numbers []uint64) error {
...
func (h *ongHandler) handleBlockBroadcast(peer *ong.Peer, block *types.Block, td *big.Int) error {
