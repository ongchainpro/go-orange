...
type peerConnection struct {
	...
	version uint       // Ong protocol version number to switch strategies
...
// Lacks retrieves whonger the hash of a blockchain item is on the peers lacking
// list (i.e. whonger we know that the peer does not have it).
...
func (ps *peerSet) HeaderIdlePeers() ([]*peerConnection, int) {
	...
	return ps.idlePeers(ong.ONG32, ong.ONG34, idle, throughput)
}
