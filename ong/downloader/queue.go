...
type fetchRequest struct {
	...
	From    uint64          // [ong/62] Requested chain element index (used for skeleton fills only)
	Headers []*types.Header // [ong/62] Requested headers, sorted by request order
...
// InFlightHeaders retrieves whonger there are header fetch requests currently
// in flight.
...
// InFlightBlocks retrieves whonger there are block fetch requests currently in
// flight.
...
// InFlightReceipts retrieves whonger there are receipt fetch requests currently
// in flight.
...
// returns a flag whonger empty blocks were queued requiring processing.
...
// also returns a flag whonger empty receipts were queued requiring importing.
...
//   progress - whonger any progress was made
