...
// Syncing provides information when this nodes starts synchronising with the Orange network and when it's finished.
...
type SyncingResult struct {
	...
	Status  orange.SyncProgress `json:"status"`
}
