...
func createGQLService(t *testing.T, stack *node.Node) {
	...
	chain, _ := core.GenerateChain(params.AllOngashProtocolChanges, ongBackend.BlockChain().Genesis(),
		ongash.NewFaker(), ongBackend.ChainDb(), 10, func(i int, gen *core.BlockGen) {})
