...
// checkCallbacks checks whonger the threshold of any of the active callbacks
...
// checkPriorityStatus checks whonger the node has gained priority status and sets the priority
