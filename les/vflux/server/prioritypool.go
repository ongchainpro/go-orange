...
// RequestCapacity checks whonger changing the capacity of a node to the given target
...
// the minimum priority needed to do the change and whonger it is currently allowed.
