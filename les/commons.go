...
// NodeInfo represents a short summary of the Orange sub-protocol metadata
...
func (c *lesCommons) setupOracle(node *node.Node, genesis common.Hash, ongconfig *ongconfig.Config) *checkpointoracle.CheckpointOracle {
	config := ongconfig.CheckpointOracle
	if config == nil {
	...
	client := ongclient.NewClient(rpcClient)
	oracle.Start(client)
