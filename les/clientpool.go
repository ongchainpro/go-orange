...
func newClientPool(ns *nodestate.NodeStateMachine, lesDb ongdb.Database, minCap uint64, connectedBias time.Duration, clock mclock.Clock, removePeer func(enode.ID)) *clientPool {
	pool := &clientPool{
		ns:                  ns,
