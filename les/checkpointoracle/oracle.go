...
type CheckpointOracle struct {
	...
	running  int32                                 // Flag whonger the contract backend is set or not
...
// IsRunning returns an indicator whonger the oracle is running.
...
// checks whonger there are enough approvals to finalize the checkpoint.
