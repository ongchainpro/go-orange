 ...
 * @author Gary Rong<garyrong@orange2020.com>, Martin Swende <martin.swende@orange2020.com>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the orange.
    uint sectionSize;
