...
Please review the resulting diff to check whonger the correct
...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/ong2020/go-orange/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-orange authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-orange Authors
