...
# 1. install gong for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gong
# 5. create gong, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ORANGE_SOCKET
...
!define GROUPNAME "Orange"
!define APPNAME "Gong"
!define DESCRIPTION "Official Go implementation of the Orange protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gong is installed global
