...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, MethodSelector *string) (*ongapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx ongapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, MethodSelector *string) (*ongapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := ongapi.SignTransactionResult{Raw: data, Tx: signedTx}
